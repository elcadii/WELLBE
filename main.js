...
document.getElementById("ProfessionnelFormBtn").addEventListener("click", () => {
  document.getElementById("ProfessionnelForm").addEventListener("submit", function (e) {
    e.preventDefault();

    // Inputs
    const ProfessionnelFullname = document.getElementById("ProfessionnelFullname").value.trim();
    const ProfessionnelEmail = document.getElementById("ProfessionnelEmail").value.trim();
    const ProfessionnelPhone = document.getElementById("ProfessionnelPhone").value.trim();
    const ProfessionnelEtablissement = document.getElementById("ProfessionnelEtablissement").value.trim();
    const ProfessionnelCity = document.getElementById("ProfessionnelCity").value.trim();

    // Errors
    const ProfessionnelFullnameError = document.getElementById("ProfessionnelFullnameError");
    const ProfessionnelEmailError = document.getElementById("ProfessionnelEmailError");
    const ProfessionnelPhoneError = document.getElementById("ProfessionnelPhoneError");
    const ProfessionnelEtablissementError = document.getElementById("ProfessionnelEtablissementError");
    const ProfessionnelCityError = document.getElementById("ProfessionnelCityError");
    ...
    if (ProfessionnelEtablissement === "") {
      ProfessionnelEtablissementError.textContent = "Le nom de lՎtablissement est requis.";
      isValid = false;
    }
...
document.getElementById("clientFormBtn").addEventListener("click", () => {
  document.getElementById("clientForm").addEventListener("submit", function (e) {
    ...
    // Inputs
    const clientFullname = document.getElementById("clientFullname").value.trim();
    const clientEmail = document.getElementById("clientEmail").value.trim();
    const clientPhone = document.getElementById("clientPhone").value.trim();
    const clientCity = document.getElementById("clientCity").value.trim();

    // Error Elements
    const clientFullnameError = document.getElementById("clientFullnameError");
